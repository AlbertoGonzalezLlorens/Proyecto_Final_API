...
insert into usuarios (username,nombre,apellidos,email,password,foto,telefono,id_rol) values ('ivan','Ivan','Herrero Rabasó','ivan.herrero@gmail.com','$2a$10$XURPShQNCsLjp1ESc2laoObo9QZDhxz73hJPaEv7/cBha4pk0AgP.',null,659852147,1);
insert into usuarios (username,nombre,apellidos,email,password,foto,telefono,id_rol) values ('alberto','Alberto','González Llorens','alberto.gonzalez@gmail.com','$2a$10$XURPShQNCsLjp1ESc2laoObo9QZDhxz73hJPaEv7/cBha4pk0AgP.',null,659852148,2);
